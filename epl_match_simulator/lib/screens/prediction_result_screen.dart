              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${player.position} 窶｢ ${player.subPosition}',
                      style: const TextStyle(
                        fontSize: 9,
                        color: Colors.grey,
                      ),
      ...
      child: Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildStatSection('識 Possession & Passing', [
            ...
            _buildStatSection('洽 Discipline', [
  ...
  Widget _buildRatingSection(MatchStats stats) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('投 Team Ratings', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.deepPurple)),
      ...
      builder: (context, snapshot) {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  Text(
                    'API騾壻ｿ｡縺ｫ螟ｱ謨励＠縺ｾ縺励◆縲ゅヵ繧ｩ繝ｼ繝ｫ繝舌ャ繧ｯ隗｣隱ｬ繧定｡ｨ遉ｺ縺励∪縺吶・n\n繧ｨ繝ｩ繝ｼ隧ｳ邏ｰ: $errorMsg',
                    style: const TextStyle(
                      fontSize: 12,
                      color: Colors.grey,
                      height: 1.4,
        ...
        if (result == null || result['analysis'] == null) {
          return const Card(
            child: Padding(
              padding: EdgeInsets.all(16),
              child: Text('蛻・梵繝・・繧ｿ縺瑚ｦ九▽縺九ｊ縺ｾ縺帙ｓ'),
            ),
          );
        }
      ...
      child: Column(
        ...
        children: [
          ...
          ...keyMoments.map((moment) {
            ...
            final event = m['event']?.toString() ?? '繧､繝吶Φ繝・;
...
class _SegmentedNarrativeViewState extends State<_SegmentedNarrativeView> {
  ...
  Widget _buildQuarterCard(Map<String, dynamic> segment) {
    ...
    final narrative = _safeGetString(
        segment, 'narrative', '隧ｦ蜷医・螳滓ｳ√′逕滓・縺輔ｌ縺ｦ縺・∪縺・..');
    final events = (segment['events'] ?? []) as List<dynamic>;
